...
-(NSArray *)dataArr
{
    if (!_dataArr) {
        _dataArr = @[
                     ...
                     @{@"折线翻转图 - Y翻转":@"icon_calc"},
                     @{@"圆图":@"icon_momentum"},
                     @{@"自定义1 - 柱状空数据":@"icon_calc"},
                     @{@"自定义2 - 圆饼空数据":@"icon_calc"},
                     @{@"自定义3 - 配速横向图表":@"icon_calc"},
                     @{@"自定义4 - 心率区间横向图表":@"icon_calc"},
                     @{@"自定义5 - X轴文本居中展示":@"icon_calc"},
                     @{@"自定义6 - X轴文本两端展示":@"icon_calc"},
                     @{@"自定义7 - X轴文本从头开始展示":@"icon_calc"},
                     @{@"自定义8 - X轴指定位置展示":@"icon_calc"},
                     @{@"进阶9 - 柱状.顶部折线展示(一组数据)":@"icon_calc"},
                     @{@"进阶10 - 折线-点图展示(一组数据)":@"icon_calc"},
                     @{@"进阶11 - 雷达网状图展示":@"icon_calc"},
                     @{@"进阶12 - 炫酷圆饼展示":@"icon_calc"},
                     @{@"进阶13 - 左右横向柱状图展示":@"icon_calc"},
                     @{@"进阶14 - 运动频率图展示":@"icon_calc"},
                     ];
    }
    return _dataArr;
}
